...
namespace UniEx
{
    ...
    {
        [SerializeField] string Clicked = "Clicked";

        [SerializeField] string Highlighted = "Highlighted";

        [SerializeField] string Normal = "Normal";

        [SerializeField] string Disabled = "Disabled";

        // 有効無効
        [SerializeField] bool interactable_ = true;
        ...
        // クリックイベント
        [SerializeField] Button.ButtonClickedEvent onClick_ = new Button.ButtonClickedEvent();
        ...
        [SerializeField] Button.ButtonClickedEvent onDisabledClick_ = new Button.ButtonClickedEvent();

        public Button.ButtonClickedEvent OnDisabledClick
        {
            get { return onDisabledClick_; }
        }
        ...
        {
            get { return cachedCollider_.GetComponentInChildren(transform); }
        }

        public bool IsEnable
        {
            get { return Interactable && CachedCollider.isTrigger; }
        }
        ...
        public bool IsValid
        {
            get { return Controller != null && Controller.isInitialized; }
        }
